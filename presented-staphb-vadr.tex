...
\includegraphics[width=10in]{figs/alerts-info-alt-format-small}
%\includegraphics[width=10in]{figs/alerts-info-toc}
%\includegraphics[width=10in]{figs/alerts-info-examples-table}
...
%\includegraphics[width=10in]{figs/alerts-info-alt-format}
%\includegraphics[width=10in]{figs/alerts-info-toc}
\includegraphics[width=10in]{figs/alerts-info-example-table-short}
